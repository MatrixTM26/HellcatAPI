...
public class HellcatResponse {
    ...
    public static HellcatResponse Redirect(String Location, int StatusCode) {
        if (Location == null || Location.isEmpty())
            throw new HellcatResponseException("RedirectResponse requires a non-empty Location");
    ...
    public static HellcatResponse FileResponse(String FilePath, String DownloadAs) {
        ...
        byte[] Data;
        try { Data = Files.readAllBytes(F.toPath()); }
        catch (IOException E) { throw new HellcatFileResponseException("Could not read file '" + FilePath + "': " + E.getMessage()); }
    ...
    public static class HellcatResponseException extends RuntimeException {
        public HellcatResponseException(String Message) { super(Message); }
    }

    public static class HellcatFileResponseException extends HellcatResponseException {
        public HellcatFileResponseException(String Message) { super(Message); }
    }
}
